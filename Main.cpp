...
int main(int argc, const char* argv[]) {
    ...
    std::cout << "-Le héros voit un bloc d'herbe, il se trouve en : " << grass_block.getLocationStr() << "." << std::endl;
    ...
    std::cout << "-Une brique vient d'apparaitre devant notre héros à l'emplacement : " << brick.getLocationStr() << ", elle est destructible et possède actuellement " << brick.getHealth() << "/" << brick.getmaxHealth() << "HP." << std::endl;
    std::cout << "-Le héros essaye de sauter sur la brique..." << std::endl;
    brick.setLocation(127.f, -1540);
    std::cout << "-La brique s'est déplacée comme par magie ! Elle se trouve désormais à l'emplacement : " << brick.getLocationStr() << "." << std::endl;
